...
const Banner = () => {
  return (
    <section id="presentation" className="bg-[#F2F0F1] relative flex flex-col">
      <article className="text-presentation w-full md:max-w-2/3 lg:max-w-2/4 py-10 px-5 sm:px-15 z-10">
        <h1 className="text-3xl sm:text-4xl md:text-5xl py-3">
          FIND CLOTHES THAT MATCHES YOUR STYLE
        </h1>
        <p className="text-sm sm:text-base opacity-60 pb-5">
      ...
      <ul className="grid grid-cols-2 gap-x-3 sm:gap-x-5 sm:grid-cols-3 lg:grid-cols-3 sm:w-full lg:w-6/12 p-4 mt-3 px-6 z-10 lg:ml-6">
